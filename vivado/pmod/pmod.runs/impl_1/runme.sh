...
HD_PWD='C:/Users/wolfg/dev/vivado/pmod/pmod.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodSWT_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodSWT_wrapper.tcl -notrace
