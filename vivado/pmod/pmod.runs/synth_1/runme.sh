...
HD_PWD='C:/Users/wolfg/dev/vivado/pmod/pmod.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodSWT_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodSWT_wrapper.tcl
