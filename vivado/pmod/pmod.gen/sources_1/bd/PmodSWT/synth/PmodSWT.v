...
//Command     : generate_target PmodSWT.bd
//Design      : PmodSWT
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "PmodSWT,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PmodSWT,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=1,da_mb_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "PmodSWT.hwdef" *) 
module PmodSWT
   (led_4bits_tri_o,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN PmodSWT_sys_clock, FREQ_HZ 12000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  PmodSWT_axi_gpio_0_0 axi_gpio_0
  ...
  PmodSWT_axi_uartlite_0_0 axi_uartlite_0
  ...
  PmodSWT_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(sys_clock_1),
        .clk_out1(microblaze_0_Clk),
        .locked(clk_wiz_0_locked),
        .resetn(reset_1));
  PmodSWT_mdm_1_1 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > PmodSWT microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  PmodSWT_microblaze_0_0 microblaze_0
  ...
  PmodSWT_microblaze_0_axi_periph_1 microblaze_0_axi_periph
  ...
  microblaze_0_local_memory_imp_1DY0SIW microblaze_0_local_memory
  ...
  PmodSWT_rst_clk_wiz_0_100M_1 rst_clk_wiz_0_100M
       (.aux_reset_in(1'b1),
...
module PmodSWT_microblaze_0_axi_periph_1
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_6DW91K m00_couplers
  ...
  m01_couplers_imp_144TKLN m01_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  s00_couplers_imp_140QZPW s00_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module m00_couplers_imp_6DW91K
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m01_couplers_imp_144TKLN
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_1DY0SIW
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > PmodSWT microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  PmodSWT_dlmb_bram_if_cntlr_1 dlmb_bram_if_cntlr
  ...
  PmodSWT_dlmb_v10_1 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  PmodSWT_ilmb_bram_if_cntlr_1 ilmb_bram_if_cntlr
...
module s00_couplers_imp_140QZPW
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
